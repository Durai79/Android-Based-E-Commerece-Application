...
public class ShowAllActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getWindow().setStatusBarColor(ContextCompat.getColor(ShowAllActivity.this, R.color.statusbarcolor));
        ...
        if (type !=null && type.equalsIgnoreCase("slipper")){

            firestore.collection("ShowAll").whereEqualTo("type","slipper")
                    .get().addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
                        @Override
                        public void onComplete(@NonNull Task<QuerySnapshot> task) {
        ...
        if (type !=null && type.equalsIgnoreCase("watches")){
            ...
            firestore.collection("ShowAll").whereEqualTo("type","watches")
                    .get().addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
                        @Override
                        public void onComplete(@NonNull Task<QuerySnapshot> task) {
